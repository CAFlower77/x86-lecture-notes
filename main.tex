...
\renewcommand{\bibname}{References | 参考文献}
...
\hypersetup{
	pdftitle={x86汇编语言：从实模式到保护模式 Lecture Notes}, % Title field
	pdfauthor={Flower CA77}, % Author field
	pdfsubject={电子技术, 计算机科学, 程序设计}, % Subject field
	% pdfkeywords={Keyword1, Keyword2, ...}, % Keywords
	pdfcreator={XeLaTeX The Legrand Orange Book}, % Content creator field
}
...
\ctikzset{american, logic ports=ieee,chips/scale=1.5}
...
\DeclareMathOperator{\bnor}{\texttt{nor}}
\DeclareMathOperator{\bnand}{\texttt{nand}}
\DeclareMathOperator{\UMax}{\texttt{UMax}}
\DeclareMathOperator{\TMax}{\texttt{TMax}}
\DeclareMathOperator{\TMin}{\texttt{TMin}}
\DeclareMathOperator{\BU}{\texttt{B2U}}
\DeclareMathOperator{\BT}{\texttt{B2T}}
\DeclareMathOperator{\UB}{\texttt{U2B}}
\DeclareMathOperator{\TB}{\texttt{T2B}}
\DeclareMathOperator{\UT}{\texttt{U2T}}
\DeclareMathOperator{\TU}{\texttt{T2U}}
...
\chapterimage{Images/bgp2.jpg}
\include{includes/ch0.tex}
\numberwithin{equation}{chapter}
\chapterimage{Images/bgp3.jpg}
\include{includes/ch1.tex}
\part{计算机组成}
\part{实模式}
\part{32位保护模式}
...
\part*{\appendixname}
\appendix
\newcommand{\realChapterNameCA}{\chaptername}
\renewcommand{\chaptername}{\appendixname}
\chapterimage{Images/bgp2.png}
\include{includes/ap1.tex}
\chapterimage{Images/bgp3.png}
\include{includes/ap2.tex}

\renewcommand{\chaptername}{\realChapterNameCA}
\let\realChapterNameCA\imareallyundefinedcommand
